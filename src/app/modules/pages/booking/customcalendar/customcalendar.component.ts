...
export class CustomcalendarComponent implements OnInit {
    ...
    performBooking() {
        this._bookingService.createBooking({
            branchCode: this.configuration.branchCode,
            formCode: this.configuration.formCode,
            customerId: this.customer.customerId,
            date: this.selectedDate.year.toString() + (this.selectedDate.month+1).toString().padStart(2, '0') + this.selectedDate.day.toString().padStart(2, '0'),
            ...
            branchAddress: this.configuration.address,
            branchName: this.configuration.branchName,
            child: 0
